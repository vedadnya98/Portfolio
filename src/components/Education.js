                    ...
                    <div className="background">
                        ...
                        <div className="container eduContainer col-12 col-sm-12 col-md-6 col-lg-6" key={i+"Education"}>
                            ...
                            <div className="card-avatar">
                                <a rel="noopener noreferrer" target="_blank" href="/#"> <img className="eduImg" src={item.img} alt="collegeLogo"/></a>
                            </div>
                            <br></br>
                            <div className="table">
                            <a rel="noopener noreferrer" target="_blank" href={item.website}><h3 className="card-caption">{item.name}</h3></a>
